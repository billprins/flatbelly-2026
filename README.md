...
- Format: team best ball, five 9-hole matches, 1 pt/hole + 1 pt match win (ties split), 80% handicaps, team index = each player's lowest of last 6 months, 10 flight winners + 1 wildcard → shootout, last team standing wins
